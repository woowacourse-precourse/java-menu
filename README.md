...
- [x] 코치의 이름을 입력받는다.
  ...
  - [x] 코치는 최소 2명, 최대 5명까지 입력받는지 검증한다.
  - [x] 쉼표로 구분한다.
  - [x] 안내 메시지를 출력한다.
  - [x] 입력 결과를 출력한다.

- [x] 각 코치마다 못 먹는 메뉴를 입력받는다.
  - [x] 못 먹는 메뉴는 각자 최소 0개, 최대 2개이다.
  - [x] 못 먹는 메뉴가 없을 때는 빈 값을 확인한다.
  - [x] 쉼표로 구분한다.
  - [x] 구현 요구 사항에 명시된 메뉴에서만 선택해야 한다.
  - [x] 안내 메시지를 출력한다.

- [x] 요일 별로 카테고리를 추천한다.
  - [x] 5개가 담긴다.
  - [x] 같은 카테고리는 최대 2회까지만 허용한다.
  - [x] Randoms.pickNumberInRange()을 사용한다.
  - [x] 요일 순서대로 정렬한다.

- [x] 각 코치에게 메뉴를 추천한다.
  - [x] 한 주에 같은 카테고리는 최대 2회까지만 고를 수 있다.
  - [x] 한 주에 중복되지 않는 메뉴를 추천해야 한다.
  - [x] 각 코치별로 CoachFoodRecommand를 생성하여 관리한다.

- [x] 최종 결과를 출력한다.
  - [x] 요일 구분 행을 출력한다.
  - [x] 카테고리 행을 출력한다.
  - [x] 각 코치에 대해서 메뉴를 추천한 결과를 출력한다.
  - [x] 시작과 끝 안내 메시지를 출력한다.
