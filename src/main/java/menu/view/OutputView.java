...
public class OutputView {
    ...
    public static final String THE_END_MESSAGE = "\n추천을 완료했습니다.";

    public void printStart(){
        System.out.println(START_MESSAGE);
    }

    public void printEnd(List<String> allCategory,Map<String, List<String>> recommendFoods){
        System.out.println(END_MESSAGE);
        printDays();
        printCategory(allCategory);
        printRecommendFoods(recommendFoods);
