...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println(categoryNameOfWeek.keySet() + " ");
        System.out.println(categoryNameOfWeek.values());
        ...
        // 코치마다 못 먹는 메뉴 제외한 식단 구하기
            for (Map.Entry<String, Set<String>> entry : coachesHateFood.entrySet()) {
                ...
                if (!entry.getValue().contains(menu)) {
                    coachesMealPlan.putIfAbsent(entry.getKey(), new HashSet<>());
...
//                    }
        ...
        for (Map.Entry<String, HashSet<String>> entry : coachesMealPlan.entrySet()) {
