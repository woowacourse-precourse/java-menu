...
public enum Category {
    ...
    private static final Map<Category, List<String>> menusRepository = new LinkedHashMap<>();

    static {
        Arrays.stream(Category.values())
                .forEach(category -> menusRepository.put(category, category.menus));
    }
    ...
    public String randomMenuByCategory() {
        return Randoms.shuffle(menusRepository.get(this)).get(0);
    }
