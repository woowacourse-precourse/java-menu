...
public class OutputView {
    ...
    public void printServiceEnd(List<CoachModel> serviceModel, List<String> selectedCategory){
    ...
    public void printMenuList(List<CoachModel> serviceModel){
        for(int i=0;i<serviceModel.size();i++){
            System.out.print(String.format("[ %s ",serviceModel.get(i).getName()));
            printMenu(serviceModel.get(i).getMenu());
            System.out.println("]");
        }
    }
