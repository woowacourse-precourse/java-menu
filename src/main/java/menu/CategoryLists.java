...
public class CategoryLists {
    ...
    List<List<String>> categoryList = Arrays.asList(
    ...
    public String get(int randNum) {
        return categories.get(randNum);
    }

    public boolean isExist(String food) {
        for (List<String> list : categoryList) {
