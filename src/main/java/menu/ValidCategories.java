...
public enum ValidCategories {
    ...
    ValidCategories(String korean, int number, List<String> menus) {
        this.korean = korean;
        this.number = number;
        this.menus = menus;
    }

    public static ValidCategories finaCategoryByName(String menuName) {
        for (ValidCategories category : values()) {
    ...
    public static ValidCategories getCategoryByNumber(int number) {
        for (ValidCategories category : values()) {
